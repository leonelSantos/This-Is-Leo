...
export default function Footer() {
  ...
  return (
    <footer className="bg-stone-400 text-white py-12">
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/blog" className="text-black hover:text-white transition-colors">
                  Blog
                </Link>
              </li>
              <li>
                <Link href="/cheatsheets" className="text-black hover:text-white transition-colors">
                  Cheatsheets
                </Link>
              </li>
              <li>
                <Link href="/playlists" className="text-black hover:text-white transition-colors">
                  Playlists
                </Link>
              </li>
              <li>
                <Link href="/books" className="text-black hover:text-white transition-colors">
                  Books
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li className="text-black">
                <a href="mailto:leonel.adan.santos@gmail.com" className="hover:text-white transition-colors">
